...
void RobotMap::init() {
    ...
    wheelieBarSOLENOID_WHEELIEBAR.reset(new DoubleSolenoid(0, 0, 6));
    lw->AddActuator("WheelieBar", "SOLENOID_WHEELIEBAR", wheelieBarSOLENOID_WHEELIEBAR);
    
    fingerSOLENOID_FINGER.reset(new DoubleSolenoid(0, 2, 4));
    lw->AddActuator("Finger", "SOLENOID_FINGER", fingerSOLENOID_FINGER);
    
    elevatorSOLENOID_ELEVATOR.reset(new DoubleSolenoid(0, 1, 3));
