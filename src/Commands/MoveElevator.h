...
/**
 * This class encapsulates the elevator command functions.
 */
class MoveElevator: public Command {
public:
	/*
	 * Initializes a new instance of the MoveElevator class. This command is the default command in the
	 * ArmElevator subsystem.
	 */
	MoveElevator();
